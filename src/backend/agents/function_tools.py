        ...
        _function_tool(
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "target_jd": {"type": "string", "description": "Optional target job description text."},
                },
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "resume_skills": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "Optional list of skills extracted from the resume.",
                    },
                },
                "required": ["clean_text", "jd_text"],
                "additionalProperties": False,
            },
        ),
    ]
