...
except ModuleNotFoundError:  # pragma: no cover - optional dependency for local/demo runs
...
class AILanguageService:
    def __init__(self, endpoint: Optional[str] = None, key: Optional[str] = None):
        ...
        if (
            ...
            and TextAnalyticsClient is not None
            ...
            logger.info("No Azure AI Language credentials configured or Azure SDK missing. Running in offline/mock mode.")
            self.is_configured = False
